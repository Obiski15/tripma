...
function MobileFlightForm() {
  ...
  return (
    <Form {...form}>
      ...
      >
        <div className="w-full flex p-3 justify-center items-center gap-4 text-foreground">
          <FormField
            name="trip"
            control={form.control}
            render={({ field }) => (
              <FormItem
                className={`flex justify-between items-center gap-1 ${
                  field.value === "round" ? "bg-primary/40 rounded-lg p-2" : ""
                }`}
              >
        ...
        <div className="w-full flex justify-between items-start gap-3">
          <div className="flex-1 flex justify-between items-center px-3 py-2 gap-2">
            <PlaneTakeoff />
        ...
        <div className="w-full flex justify-start items-start gap-3">
          <Popover>
            ...
            <PopoverTrigger className="flex-1 flex justify-start items-center px-3 py-2 gap-2 border-[1px] border-border rounded-md">
              <CalendarDaysIcon />
              {!watchedDate?.from
                ? "Pick a date"
                : `${
...
export default MobileFlightForm;
